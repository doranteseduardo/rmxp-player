...
pub fn init() -> Result<()> {
    unsafe {
        ...
        define_method(klass, cstr(b"dispose\0"), tilemap_dispose, -1);
        define_method(klass, cstr(b"disposed?\0"), tilemap_disposed_q, -1);
        define_method(klass, cstr(b"viewport\0"), tilemap_get_viewport, -1);
        define_method(klass, cstr(b"viewport=\0"), tilemap_set_viewport, -1);
        define_method(klass, cstr(b"tileset\0"), tilemap_get_tileset, -1);
        define_method(klass, cstr(b"tileset=\0"), tilemap_set_tileset, -1);
        define_method(klass, cstr(b"autotiles\0"), tilemap_get_autotiles, -1);
        define_method(klass, cstr(b"autotiles=\0"), tilemap_set_autotiles, -1);
        define_method(klass, cstr(b"bitmaps\0"), tilemap_get_autotiles, -1);
        define_method(klass, cstr(b"bitmaps=\0"), tilemap_set_autotiles, -1);
        define_method(klass, cstr(b"map_data\0"), tilemap_get_map_data, -1);
        define_method(klass, cstr(b"map_data=\0"), tilemap_set_map_data, -1);
        define_method(klass, cstr(b"priorities\0"), tilemap_get_priorities, -1);
        define_method(klass, cstr(b"priorities=\0"), tilemap_set_priorities, -1);
        define_method(klass, cstr(b"flash_data\0"), tilemap_get_flash_data, -1);
        define_method(klass, cstr(b"flash_data=\0"), tilemap_set_flash_data, -1);
        define_method(klass, cstr(b"ox\0"), tilemap_get_ox, -1);
        define_method(klass, cstr(b"ox=\0"), tilemap_set_ox, -1);
        define_method(klass, cstr(b"oy\0"), tilemap_get_oy, -1);
        define_method(klass, cstr(b"oy=\0"), tilemap_set_oy, -1);
        define_method(klass, cstr(b"visible\0"), tilemap_get_visible, -1);
        define_method(klass, cstr(b"visible=\0"), tilemap_set_visible, -1);
        define_method(klass, cstr(b"opacity\0"), tilemap_get_opacity, -1);
        define_method(klass, cstr(b"opacity=\0"), tilemap_set_opacity, -1);
        define_method(klass, cstr(b"blend_type\0"), tilemap_get_blend_type, -1);
        define_method(klass, cstr(b"blend_type=\0"), tilemap_set_blend_type, -1);
        define_method(klass, cstr(b"tone\0"), tilemap_get_tone, -1);
        define_method(klass, cstr(b"tone=\0"), tilemap_set_tone, -1);
        define_method(klass, cstr(b"color\0"), tilemap_get_color, -1);
        define_method(klass, cstr(b"color=\0"), tilemap_set_color, -1);
        define_method(klass, cstr(b"update\0"), tilemap_update, -1);
        define_method(klass, cstr(b"native_id\0"), tilemap_native_id, -1);
        init_autotile_proxy()?;
    }
    Ok(())
}
...
fn init_autotile_proxy() -> Result<()> {
    unsafe {
        ...
        define_method(klass, cstr(b"each\0"), autotile_each, -1);
        define_method(klass, cstr(b"length\0"), autotile_length, -1);
        define_method(klass, cstr(b"size\0"), autotile_length, -1);
