...
pub fn init() -> Result<()> {
    unsafe {
        ...
        define_method(klass, cstr(b"dispose\0"), plane_dispose, -1);
        define_method(klass, cstr(b"disposed?\0"), plane_disposed_q, -1);
        define_method(klass, cstr(b"viewport\0"), plane_get_viewport, -1);
        define_method(klass, cstr(b"viewport=\0"), plane_set_viewport, -1);
        define_method(klass, cstr(b"bitmap\0"), plane_get_bitmap, -1);
        define_method(klass, cstr(b"bitmap=\0"), plane_set_bitmap, -1);
        define_method(klass, cstr(b"z\0"), plane_get_z, -1);
        define_method(klass, cstr(b"z=\0"), plane_set_z, -1);
        define_method(klass, cstr(b"ox\0"), plane_get_ox, -1);
        define_method(klass, cstr(b"ox=\0"), plane_set_ox, -1);
        define_method(klass, cstr(b"oy\0"), plane_get_oy, -1);
        define_method(klass, cstr(b"oy=\0"), plane_set_oy, -1);
        define_method(klass, cstr(b"zoom_x\0"), plane_get_zoom_x, -1);
        define_method(klass, cstr(b"zoom_x=\0"), plane_set_zoom_x, -1);
        define_method(klass, cstr(b"zoom_y\0"), plane_get_zoom_y, -1);
        define_method(klass, cstr(b"zoom_y=\0"), plane_set_zoom_y, -1);
        define_method(klass, cstr(b"opacity\0"), plane_get_opacity, -1);
        define_method(klass, cstr(b"opacity=\0"), plane_set_opacity, -1);
        define_method(klass, cstr(b"blend_type\0"), plane_get_blend_type, -1);
        define_method(klass, cstr(b"blend_type=\0"), plane_set_blend_type, -1);
        define_method(klass, cstr(b"visible\0"), plane_get_visible, -1);
        define_method(klass, cstr(b"visible=\0"), plane_set_visible, -1);
        define_method(klass, cstr(b"tone\0"), plane_get_tone, -1);
        define_method(klass, cstr(b"tone=\0"), plane_set_tone, -1);
        define_method(klass, cstr(b"color\0"), plane_get_color, -1);
        define_method(klass, cstr(b"color=\0"), plane_set_color, -1);
        define_method(klass, cstr(b"native_id\0"), plane_native_id, -1);
        define_method(klass, cstr(b"update\0"), plane_update, -1);
    }
    Ok(())
}
